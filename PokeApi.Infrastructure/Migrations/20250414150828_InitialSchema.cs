    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPokemons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamPokemons_Pokemons_PokemonId",
                        column: x => x.PokemonId,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPokemons_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPokemons_PokemonId",
                table: "TeamPokemons",
                column: "PokemonId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPokemons_TeamId",
                table: "TeamPokemons",
                column: "TeamId");
        }
